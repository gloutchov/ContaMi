...
**Stato corrente:** M27 è implementata, verificata localmente e integrata in `main`; il checkpoint `v1.17.0` è taggato localmente, mentre l'esito di CI e pubblicazione non è ancora documentato nel piano. La milestone introduce rendimenti percentuali mensili e annuali per investimenti, comparti pensione e immobili locati, mantenendo separati rendimento finanziario e rendimento locativo. M28 è implementata e verificata localmente sul branch `milestone/28-vehicle-entry-assistance`; CI, integrazione e release `v1.18.0` restano da eseguire. M29 è pianificata come milestone successiva. L'ultimo checkpoint completato e documentato come rilasciato resta `v1.16.0` con M26. Le sezioni **Attività pianificate** delle milestone già chiuse conservano il perimetro originario e non rappresentano lavoro ancora da eseguire.
...
| M27 — Rendimenti percentuali patrimoniali | `milestone/27-asset-return-charts` | `1.17.0` | Implementata, verificata e integrata in `main`; esito CI/release da documentare |
| M28 — Inserimento assistito delle registrazioni Automobile | `milestone/28-vehicle-entry-assistance` | `1.18.0` | Implementata e verificata localmente; CI/release da eseguire |
| M29 — Codice ISIN opzionale per investimenti | `milestone/29-investment-isin` | `1.19.0` | Pianificata |
...
**Checkpoint desktop presente localmente:** `v1.17.0` con M27; l'esito della promozione pubblica non è ancora registrato nel piano. I checkpoint successivi previsti sono `v1.18.0` con M28 e `v1.19.0` con M29.
